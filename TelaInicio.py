...
class TelaInicio:
    ...
    def desenha(self, window):
        window.fill((51,212,255))

        imagem_texto = self.fonte_48.render('TELA INICIAL', True, (131, 57, 99))
        rect_texto = imagem_texto.get_rect()
        rect_texto.center = (WIDTH // 2, HEIGHT // 2)
        window.blit(imagem_texto, rect_texto)

        imagem_texto_2 = self.fonte_20.render('Pressione ESPAÇO para continuar', True, (131, 57, 99))
    ...
    def atualiza(self):
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                return JOGO # quando o usuário pressionar espaço, muda para a tela de jogo
        return INICIO