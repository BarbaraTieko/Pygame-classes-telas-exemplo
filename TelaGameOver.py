...
class TelaGameOver:
    ...
    def desenha(self, window):
        window.fill((255, 51, 147))

        imagem_texto = self.fonte_48.render('GAME OVER', True, (255, 243, 51))
        rect_texto = imagem_texto.get_rect()
        rect_texto.center = (WIDTH // 2, HEIGHT // 2)
        window.blit(imagem_texto, rect_texto)

        imagem_texto_2 = self.fonte_20.render('Pressione ESPAÇO para voltar ao início', True, (255, 243, 51))
